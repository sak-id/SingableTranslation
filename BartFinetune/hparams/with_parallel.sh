...
REAL_TEST_DATASET_DIR="../Dataset/datasets/real"
...
# ---------- For testing with real English lyrics with recommended rhyme -----------
REAL_TEST_OUTPUT_FILE_PATH=${OUTPUT_DIR}/testset=real/output.txt
